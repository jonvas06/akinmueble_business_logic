...
> {
  ...
  public readonly advisor: BelongsToAccessor<
    Advisor,
    typeof Request.prototype.id
  >;

  public readonly requestType: BelongsToAccessor<
    RequestType,
    typeof Request.prototype.id
  >;

  public readonly requestStatus: BelongsToAccessor<
    RequestStatus,
    typeof Request.prototype.id
  >;
  ...
  constructor(
    ...
    @repository.getter('AdvisorRepository')
    protected advisorRepositoryGetter: Getter<AdvisorRepository>,
    @repository.getter('RequestTypeRepository')
    protected requestTypeRepositoryGetter: Getter<RequestTypeRepository>,
    @repository.getter('RequestStatusRepository')
    protected requestStatusRepositoryGetter: Getter<RequestStatusRepository>,
    ...
    this.requestStatus = this.createBelongsToAccessorFor(
      'requestStatus',
      requestStatusRepositoryGetter,
    );
    this.registerInclusionResolver(
      'requestStatus',
      this.requestStatus.inclusionResolver,
    );
    this.requestType = this.createBelongsToAccessorFor(
      'requestType',
      requestTypeRepositoryGetter,
    );
    this.registerInclusionResolver(
      'requestType',
      this.requestType.inclusionResolver,
    );
    this.advisor = this.createBelongsToAccessorFor(
      'advisor',
      advisorRepositoryGetter,
    );
